...
var _createStackNavigator = require("./navigators/createStackNavigator");
var _Header = require("./views/Header/Header");
var _StackView = require("./views/Stack/StackView");
...
var _useCardAnimation = require("./utils/useCardAnimation");
var _useGestureHandlerRef = require("./utils/useGestureHandlerRef");
