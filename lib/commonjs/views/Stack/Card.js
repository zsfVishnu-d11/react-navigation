...
exports.getIsModalPresentation = exports.Card = void 0;
var _color = _interopRequireDefault(require("color"));
var React = _interopRequireWildcard(require("react"));
var _reactNative = require("react-native");
var _CardStyleInterpolators = require("../../TransitionConfigs/CardStyleInterpolators");
var _CardAnimationContext = require("../../utils/CardAnimationContext");
var _getDistanceForDirection = require("../../utils/getDistanceForDirection");
var _getInvertedMultiplier = require("../../utils/getInvertedMultiplier");
var _memoize = require("../../utils/memoize");
var _GestureHandler = require("../GestureHandler");
var _ModalStatusBarManager = require("../ModalStatusBarManager");
...
class Card extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (gestureDirection !== prevProps.gestureDirection) {
      this.inverted.setValue((0, _getInvertedMultiplier.getInvertedMultiplier)(gestureDirection));
    }
  ...
  inverted = new _reactNative.Animated.Value((0, _getInvertedMultiplier.getInvertedMultiplier)(this.props.gestureDirection));
  layout = {
  ...
  getAnimateToValue = _ref4 => {
    ...
    return (0, _getDistanceForDirection.getDistanceForDirection)(layout, gestureDirection);
  };
      ...
      case _GestureHandler.GestureState.END:
        {
          ...
          const closing = (translation + velocity * gestureVelocityImpact) * (0, _getInvertedMultiplier.getInvertedMultiplier)(gestureDirection) > distance / 2 ? velocity !== 0 || translation !== 0 : this.props.closing;
          this.animate({
            closing,
            velocity
          });
  ...
  gestureActivationCriteria() {
    ...
    if (gestureDirection === 'vertical') {
      ...
      const invertedMultiplier = (0, _getInvertedMultiplier.getInvertedMultiplier)(gestureDirection);
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement(_CardAnimationContext.CardAnimationContext.Provider, {
      value: interpolationProps
    },
    // StatusBar messes with translucent status bar on Android
    // So we should only enable it on iOS
    _reactNative.Platform.OS === 'ios' && overlayEnabled && next && getIsModalPresentation(styleInterpolator) ? /*#__PURE__*/React.createElement(_ModalStatusBarManager.ModalStatusBarManager, {
      ...
      pointerEvents: "none"
    }) : null, /*#__PURE__*/React.createElement(_CardSheet.CardSheet, {
      ref: this.ref,
