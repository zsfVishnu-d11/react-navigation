...
var _HeaderSegment = require("./HeaderSegment");
...
const Header = /*#__PURE__*/React.memo(function Header(_ref) {
  let {
    back,
    layout,
    progress,
  ...
  const goBack = React.useCallback((0, _debounce.debounce)(() => {
  ...
  return /*#__PURE__*/React.createElement(_HeaderSegment.HeaderSegment, _extends({}, options, {
