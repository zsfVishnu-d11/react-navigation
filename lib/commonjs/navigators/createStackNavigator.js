...
function StackNavigator(_ref) {
  ...
  return /*#__PURE__*/React.createElement(NavigationContent, null, /*#__PURE__*/React.createElement(_StackView.StackView, _extends({}, rest, {
    state: state,
    descriptors: descriptors,
    navigation: navigation
  })));
}
const createStackNavigator = (0, _native.createNavigatorFactory)(StackNavigator);
